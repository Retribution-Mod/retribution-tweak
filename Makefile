...
before-all::
	...
	$(ECHO_NOTHING)curl -L --fail --max-time 120 -o Resources/bundle-new.min.js https://github.com/Retribution-Mod/Retribution-IPA/releases/latest/download/retribution-new.min.js || true$(ECHO_END)
